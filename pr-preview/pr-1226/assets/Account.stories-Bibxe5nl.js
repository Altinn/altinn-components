import{a7 as o}from"./iframe-Ci8DJ-6R.js";import{G as e}from"./GlobalAccountButton-nts2RdNV.js";import{u}from"./useAccountMenu-C3n_TK9i.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-D3AIreGS.js";import"./ChevronDown-DepqY6FK.js";import"./Enter-DGbkUpmN.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-CtwhvWNz.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
