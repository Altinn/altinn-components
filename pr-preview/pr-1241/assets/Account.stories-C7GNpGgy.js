import{a7 as o}from"./iframe-KbHODQgb.js";import{G as e}from"./GlobalAccountButton-DaatQQtc.js";import{u}from"./useAccountMenu-DqwVjPm-.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-DL544SyI.js";import"./ChevronDown-DDGA5gfO.js";import"./Enter-CpZn4cxl.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-D_GdJ6TD.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
