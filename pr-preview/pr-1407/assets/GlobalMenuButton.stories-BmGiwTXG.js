import{G as l}from"./GlobalMenuButton-2oXs0ofK.js";import"./iframe-CsUY_6Pm.js";import"./preload-helper-PPVm8Dsz.js";import"./MenuHamburger-DJzN0Krn.js";import"./Badge-BOHDhK-I.js";import"./Tooltip-C1hkokj-.js";const{expect:r,within:i}=__STORYBOOK_MODULE_TEST__,b={title:"Layout/GlobalMenuButton",component:l,tags:["autodocs"],parameters:{layout:"centered"},args:{}},e={args:{}},a={args:{expanded:!0}},n={args:{badge:{variant:"base",color:"alert",label:"2"}}},t={globals:{viewport:{value:"mobile1"}},parameters:{screenshot:{skip:!0}},play:async({canvasElement:o})=>{const s=i(o),c=s.getByText("Menu");await r(c.getBoundingClientRect().width).toBeLessThanOrEqual(1),await r(s.getByRole("button",{name:"Menu"})).toBeInTheDocument()}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {}
