import{a7 as o}from"./iframe-C7-WWuUz.js";import{G as e}from"./GlobalAccountButton-BH_ckUBo.js";import{u}from"./useAccountMenu-DWUOOAkf.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-DglSEPrl.js";import"./ChevronDown-BuDxjQRv.js";import"./Enter-CeJcfmZn.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-BW3phxWL.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
