import{a7 as o}from"./iframe-BRgClhpr.js";import{G as e}from"./GlobalAccountButton-DwK-oShf.js";import{u}from"./useAccountMenu-BIQOeZRl.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-X_UXtw_G.js";import"./ChevronDown-B8Xryl2N.js";import"./Enter-D6YYWoZK.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-CiU8pCIe.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
