import{a7 as o}from"./iframe-Drliw4W2.js";import{G as e}from"./GlobalAccountButton-DDw3A2Zm.js";import{u}from"./useAccountMenu-BNvWUwzg.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-BwQy9G5d.js";import"./ChevronDown-CG1jtrk-.js";import"./Enter-_LQqEQi1.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-Dceq-Y4A.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
