import{a7 as o}from"./iframe-C3-39QZn.js";import{G as e}from"./GlobalAccountButton-1c1oP4o_.js";import{u}from"./useAccountMenu-Bs3BLusA.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-WM3RFSU5.js";import"./ChevronDown-C_O64CkH.js";import"./Enter-FSzNSatz.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-l3zYTDm7.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
