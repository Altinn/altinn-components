import{a7 as o}from"./iframe-B0WoJH5H.js";import{G as e}from"./GlobalAccountButton-Dc0u35gL.js";import{u}from"./useAccountMenu-D1gjhGAY.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-DoqQG8m_.js";import"./ChevronDown-BDG9HWsL.js";import"./Enter-BHXFCvcD.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-hNWkwNox.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
