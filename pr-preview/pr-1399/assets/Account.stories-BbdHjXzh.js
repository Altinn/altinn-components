import{a7 as o}from"./iframe-B1m5YS-z.js";import{G as e}from"./GlobalAccountButton-DyKdbs9d.js";import{u}from"./useAccountMenu-DKP_rPhI.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-Xyg1H9P0.js";import"./ChevronDown-VNvIPDL4.js";import"./Enter-CQoyFxIR.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-CsIEHATU.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
