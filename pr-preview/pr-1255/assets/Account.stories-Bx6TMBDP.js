import{a7 as o}from"./iframe-2h8IP8d3.js";import{G as e}from"./GlobalAccountButton-CiVU53Gm.js";import{u}from"./useAccountMenu-DsZ-X426.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-C_KS8ezx.js";import"./ChevronDown-D2-mCLBn.js";import"./Enter-DM5C-XCw.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-Bde1mNCW.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
