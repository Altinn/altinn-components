import{a7 as o}from"./iframe-h3kpEY-8.js";import{G as e}from"./GlobalAccountButton-TxNOomJT.js";import{u}from"./useAccountMenu-0SZwhbez.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-xrrnEYLD.js";import"./ChevronDown-lfOvIfMJ.js";import"./Enter-CRzvfXkr.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-fTOJiR6e.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
