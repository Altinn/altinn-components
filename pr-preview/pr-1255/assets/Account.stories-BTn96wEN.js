import{a7 as o}from"./iframe-CdYVD6SD.js";import{G as e}from"./GlobalAccountButton-rBopz-2t.js";import{u}from"./useAccountMenu-A8Qr3ZoP.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-fMwGn-3G.js";import"./ChevronDown-C8P1GjsS.js";import"./Enter-DyFWDY5O.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-CmLcNOlW.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
