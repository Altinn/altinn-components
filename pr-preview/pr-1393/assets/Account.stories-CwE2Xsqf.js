import{a7 as o}from"./iframe-ypmT5Gk0.js";import{G as e}from"./GlobalAccountButton-CQvD92YT.js";import{u}from"./useAccountMenu-DMo6V2Lc.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-CjSTwin0.js";import"./ChevronDown-BK7qLjN-.js";import"./Enter-BI3IQ34V.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-LtBxKwOH.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
