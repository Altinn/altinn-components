import{a7 as o}from"./iframe-DXZBp66t.js";import{G as e}from"./GlobalAccountButton-Bg057Jyv.js";import{u}from"./useAccountMenu-C9iR3xM8.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-DCOejOD4.js";import"./ChevronDown-nMZldMxX.js";import"./Enter-EW9WI_Pj.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-DYB-vTQ0.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
