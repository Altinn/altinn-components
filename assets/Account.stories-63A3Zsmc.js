import{a7 as o}from"./iframe-Byxtd80g.js";import{G as e}from"./GlobalAccountButton-CNkq2zuz.js";import{u}from"./useAccountMenu-Dd9y_0Mc.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-DhukG_GJ.js";import"./ChevronDown-Bl8PHeKm.js";import"./Enter-DFJxMCsB.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-M1FbN85e.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
