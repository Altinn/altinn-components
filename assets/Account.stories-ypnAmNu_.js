import{a7 as o}from"./iframe-Cj7V21km.js";import{G as e}from"./GlobalAccountButton-DIIuy-_h.js";import{u}from"./useAccountMenu-CdZ1XpdU.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-D_h-dTDE.js";import"./ChevronDown-SIqR4dbe.js";import"./Enter-f6aYZdhd.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-B0fwXfOV.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
