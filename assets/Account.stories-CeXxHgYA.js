import{a7 as o}from"./iframe-BkdCVhNa.js";import{G as e}from"./GlobalAccountButton-B6C1II4k.js";import{u}from"./useAccountMenu-DWgMwsyd.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-BIkq-2V8.js";import"./ChevronDown-DHl1_IXJ.js";import"./Enter-DiGWFFtb.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-CFXxrMYr.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
