import{aa as a,a7 as e,c as n}from"./iframe-C2dzRmjh.js";import{b as H}from"./brreg-2IRVVnCD.js";import{S as L}from"./ExternalLink-BhDcDV7R.js";import{S as A}from"./Bell-CFAhbo75.js";import{M as p,b as g,a as h}from"./ModalBody-EYKNgO6y.js";import{A as E}from"./AccountNotificationSettings-C5ASNCTu.js";import{B as d}from"./ButtonGroup-BU_SIQJX.js";import{M as v}from"./Modal-DNMhx0RE.js";import{T as u}from"./Typography-DJs4mnKu.js";import{C as X}from"./Checkbox-CqgcXp2y.js";import{H as P}from"./Heading-CfKKA19E.js";import{F as G}from"./Flex-Cz2ESd29.js";import{F as I}from"./Fieldset-f7lBh5K_.js";import{T as N}from"./TextField-ZDeL-kQh.js";import{S as z}from"./Switch-CzhDNOrG.js";import"./preload-helper-PPVm8Dsz.js";import"./Section-DIoxVkTZ.js";import"./Avatar-JufbU_Wx.js";import"./AvatarGroup-Dco4ceHR.js";import"./useHighlightedText-DV4hS6Cx.js";import"./Field-B-1S4h3H.js";import"./Input-DA-lDvIm.js";import"./Label-_M2OAFvX.js";import"./FieldBase-Dvh5lIYF.js";const de={title:"Components/Modal",component:p,args:{},parameters:{layout:"centered"}},C=t=>{const[o,s]=a.useState(!0),r=()=>{s(i=>!i)};return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:r,children:"Open modal"}),e.jsxs(v,{...t,open:o,onClose:r,children:[e.jsx(P,{size:"xl",children:"Title"}),e.jsx(u,{children:e.jsx("p",{children:"Modal content."})})]})]})},B=t=>{const[o,s]=a.useState(!0),r=()=>{s(i=>!i)};return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:r,children:"Open modal"}),e.jsxs(v,{...t,open:o,onClose:r,dismissable:!0,children:[e.jsx(P,{size:"xl",children:"Title"}),e.jsx(u,{children:e.jsx("p",{children:"Modal content."})})]})]})},S=()=>{const[t,o]=a.useState(!0),s=()=>{o(r=>!r)};return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:s,children:"Open modal"}),e.jsxs(v,{open:t,onClose:s,closedBy:"none",children:[e.jsxs(u,{children:[e.jsx("h1",{children:"Før du går videre ..."}),e.jsx("p",{children:"Du forlater nå Altinn og går over til Skatteetaten."})]}),e.jsxs(d,{children:[e.jsx(n,{onClick:s,children:"Fint, fortsett"}),e.jsx(n,{onClick:s,variant:"outline",children:"Nei, avbryt"})]})]})]})},M=()=>{const[t,o]=a.useState(!0),s=()=>{o(r=>!r)};return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:s,children:"Open modal"}),e.jsxs(v,{open:t,onClose:s,closedBy:"none",children:[e.jsxs(u,{children:[e.jsx("h1",{children:"Vent litt!"}),e.jsx("p",{children:"Er du sikker på at du vil slette hele innboksen din?"})]}),e.jsxs(d,{children:[e.jsx(n,{onClick:s,variant:"outline",children:"Nei, avbryt"}),e.jsx(n,{onClick:s,color:"danger",children:"Ja, gå videre"})]})]})]})},y=()=>{const[t,o]=a.useState(!0),s=()=>{o(r=>!r)};return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:s,children:"Open modal"}),e.jsxs(v,{open:t,onClose:s,children:[e.jsxs(u,{children:[e.jsx("h1",{children:"Vent litt!"}),e.jsx("p",{children:"Er du sikker på at du vil slette hele innboksen din?"})]}),e.jsx(X,{label:"Ikke vis dette igjen"}),e.jsxs(d,{children:[e.jsx(n,{children:"Ja, gå videre"}),e.jsx(n,{variant:"outline",children:"Nei, absolutt ikke"})]})]})]})},k=()=>{const[t,o]=a.useState(!0),s=()=>{o(c=>!c)},[r,i]=a.useState({smsAlerts:!1}),f=c=>{const{type:x,checked:b,name:m,value:j}=c.target;i(x==="checkbox"?l=>({...l,[m]:b}):l=>({...l,[m]:j}))};return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:s,children:"Open modal"}),e.jsxs(v,{open:t,onClose:s,children:[e.jsxs(u,{children:[e.jsx("h1",{children:"Før du går videre ..."}),e.jsxs("p",{children:["Vi mangler varslingsadresser for ",e.jsx("strong",{children:"Bergen bar"}),"."]}),e.jsx("p",{children:"Legg inn en bedriftens e-post og evt. et telefonnummer for å motta varslinger om nytt innhold."})]}),e.jsxs(I,{size:"sm",children:[e.jsx(N,{label:"E-postadresse for varslinger",name:"email",placeholder:"E-postadresse"}),e.jsx(z,{onChange:f,label:"Varsle på SMS",name:"smsAlerts",value:"sms"}),r?.smsAlerts&&e.jsx(N,{name:"sms",placeholder:"Mobiltelefon"})]}),e.jsxs(d,{children:[e.jsx(n,{children:"Lagre og gå videre"}),e.jsx(n,{variant:"outline",children:"Hopp over"})]})]})]})},D=t=>{const[o,s]=a.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:()=>s(!0),children:"Open modal"}),e.jsxs(p,{...t,open:o,onClose:()=>s(!1),variant:"content",children:[e.jsx(g,{title:"Modal title",onClose:()=>s(!1)}),e.jsx(h,{children:e.jsxs(u,{children:[e.jsx("p",{children:"Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Nullam quis risus eget urna mollis ornare vel eu leo. Donec ullamcorper nulla non metus auctor fringilla. Donec id elit non mi porta gravida at eget metus. Donec sed odio dui. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus."}),e.jsx("p",{children:"Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum id ligula porta felis euismod semper. Cras mattis consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl consectetur et."}),e.jsx("p",{children:"Nullam quis risus eget urna mollis ornare vel eu leo. Vestibulum id ligula porta felis euismod semper. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula porta felis euismod semper. Nullam quis risus eget urna mollis ornare vel eu leo. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."}),e.jsx("p",{children:"Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vestibulum id ligula porta felis euismod semper. Donec ullamcorper nulla non metus auctor fringilla. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Etiam porta sem malesuada magna mollis euismod."}),e.jsx("p",{children:"Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Nullam quis risus eget urna mollis ornare vel eu leo. Donec ullamcorper nulla non metus auctor fringilla. Donec id elit non mi porta gravida at eget metus. Donec sed odio dui. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus."}),e.jsx("p",{children:"Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum id ligula porta felis euismod semper. Cras mattis consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl consectetur et."}),e.jsx("p",{children:"Nullam quis risus eget urna mollis ornare vel eu leo. Vestibulum id ligula porta felis euismod semper. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula porta felis euismod semper. Nullam quis risus eget urna mollis ornare vel eu leo. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."}),e.jsx("p",{children:"Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vestibulum id ligula porta felis euismod semper. Donec ullamcorper nulla non metus auctor fringilla. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Etiam porta sem malesuada magna mollis euismod."})]})})]})]})},O=t=>{const[o,s]=a.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:()=>s(!0),children:"Open modal"}),e.jsxs(p,{...t,open:o,onClose:()=>s(!1),variant:"content",children:[e.jsx(g,{title:"Modal title",onClose:()=>s(!1),sticky:!1}),e.jsx(h,{children:e.jsxs(u,{children:[e.jsx("p",{children:"Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Nullam quis risus eget urna mollis ornare vel eu leo. Donec ullamcorper nulla non metus auctor fringilla. Donec id elit non mi porta gravida at eget metus. Donec sed odio dui. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus."}),e.jsx("p",{children:"Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum id ligula porta felis euismod semper. Cras mattis consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl consectetur et."}),e.jsx("p",{children:"Nullam quis risus eget urna mollis ornare vel eu leo. Vestibulum id ligula porta felis euismod semper. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula porta felis euismod semper. Nullam quis risus eget urna mollis ornare vel eu leo. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."}),e.jsx("p",{children:"Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vestibulum id ligula porta felis euismod semper. Donec ullamcorper nulla non metus auctor fringilla. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Etiam porta sem malesuada magna mollis euismod."}),e.jsx("p",{children:"Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Nullam quis risus eget urna mollis ornare vel eu leo. Donec ullamcorper nulla non metus auctor fringilla. Donec id elit non mi porta gravida at eget metus. Donec sed odio dui. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus."}),e.jsx("p",{children:"Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum id ligula porta felis euismod semper. Cras mattis consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl consectetur et."}),e.jsx("p",{children:"Nullam quis risus eget urna mollis ornare vel eu leo. Vestibulum id ligula porta felis euismod semper. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum id ligula porta felis euismod semper. Nullam quis risus eget urna mollis ornare vel eu leo. Morbi leo risus, porta ac consectetur ac, vestibulum at eros."}),e.jsx("p",{children:"Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Vestibulum id ligula porta felis euismod semper. Donec ullamcorper nulla non metus auctor fringilla. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Etiam porta sem malesuada magna mollis euismod."})]})})]})]})},q={render:t=>{const[o,s]=a.useState(!0);return e.jsxs(G,{padding:4,children:[e.jsx(n,{onClick:()=>s(!0),children:"Open modal"}),e.jsxs(p,{...t,open:o,onClose:()=>s(!1),variant:"full",children:[e.jsx(g,{title:"Modal title",onClose:()=>s(!1)}),e.jsx(h,{children:e.jsx("p",{children:"Modal content."})})]})]})}},T=t=>{const[o,s]=a.useState(!0),[r,i]=a.useState({smsAlerts:!0,phone:"99005544"}),f=c=>{const{type:x,checked:b,name:m,value:j}=c.target;i(x==="checkbox"?l=>({...l,[m]:b}):l=>({...l,[m]:j}))};return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:()=>s(!0),children:"Open modal"}),e.jsxs(p,{...t,open:o,onClose:()=>s(!1),children:[e.jsx(g,{icon:{type:"company",name:"Bergen Bar"},title:"Bergen Bar",description:"Org nr. XXX XXX XXX",onClose:()=>s(!1)}),e.jsxs(h,{children:[e.jsx(E,{...t,...r,onChange:f}),e.jsxs(d,{children:[e.jsx(n,{children:"Lagre og avslutt"}),e.jsx(n,{variant:"outline",children:"Avbryt"})]})]})]})]})},F=t=>{const[o,s]=a.useState(!0),[r,i]=a.useState({smsAlerts:!0,phone:"99005544"}),f=c=>{const{type:x,checked:b,name:m,value:j}=c.target;i(x==="checkbox"?l=>({...l,[m]:b}):l=>({...l,[m]:j}))};return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:()=>s(!0),children:"Open modal"}),e.jsxs(p,{...t,open:o,onClose:()=>s(!1),children:[e.jsx(g,{icon:A,title:"Varslinger",onClose:()=>s(!1)}),e.jsxs(h,{children:[e.jsx(E,{...t,...r,onChange:f}),e.jsxs(d,{children:[e.jsx(n,{children:"Lagre og avslutt"}),e.jsx(n,{variant:"outline",children:"Avbryt"})]})]})]})]})},V=t=>{const[o,s]=a.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:()=>s(!0),children:"Open modal"}),e.jsxs(p,{...t,open:o,onClose:()=>s(!1),children:[e.jsx(g,{icon:H,title:"Varslinger",onClose:()=>s(!1)}),e.jsxs(h,{children:[e.jsxs(u,{size:"sm",children:[e.jsx("p",{children:"Hvis det har skjedd endringer i informasjonen som er registrert på selskapet, må du melde fra om dette i Samordnet registermelding."}),e.jsxs("p",{children:["Samordet registermelding finner du på ",e.jsx("a",{href:"https://brreg.no/",children:"brreg.no"}),"."]})]}),e.jsx(d,{size:"md",children:e.jsxs(n,{variant:"outline",children:[e.jsx(L,{}),e.jsx("span",{children:"Samordnet registermelding"})]})})]})]})," "]})};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`(args: ModalProps) => {
...
}`,...V.parameters?.docs?.source}}};const ge=["Default","Dismissable","ConfirmDialog","DangerDialog","ConfirmDismissDialog","OptionsDialog","Content","NonStickyHeader","Full","CompanyModal","SettingsModal","ExternalModal"];export{T as CompanyModal,S as ConfirmDialog,y as ConfirmDismissDialog,D as Content,M as DangerDialog,C as Default,B as Dismissable,V as ExternalModal,q as Full,O as NonStickyHeader,k as OptionsDialog,F as SettingsModal,ge as __namedExportsOrder,de as default};
