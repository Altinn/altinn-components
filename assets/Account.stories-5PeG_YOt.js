import{a7 as o}from"./iframe-DWR_BPge.js";import{G as e}from"./GlobalAccountButton-DUBOmq2b.js";import{u}from"./useAccountMenu-BUhzrhNb.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-Cok-GZxK.js";import"./ChevronDown-DyMHpH4k.js";import"./Enter-BY3t1N2F.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-fRtY9Ved.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
