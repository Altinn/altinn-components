import{a7 as o}from"./iframe-B8reGtNb.js";import{G as e}from"./GlobalAccountButton-DuBGo6fg.js";import{u}from"./useAccountMenu-RI6BdrHE.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-DjLw-5ab.js";import"./ChevronDown-Cin8-QCk.js";import"./Enter-CLqIKE_3.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-Cd3MetJy.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
