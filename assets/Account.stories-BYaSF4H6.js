import{a7 as o}from"./iframe-Ca4u80-y.js";import{G as e}from"./GlobalAccountButton-B2aUt3kB.js";import{u}from"./useAccountMenu-CSlkymXu.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-D0Cbhk4B.js";import"./ChevronDown-ewsJqjFk.js";import"./Enter-CDkzTut5.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-BEhM8FIG.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
