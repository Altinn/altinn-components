import{a7 as o}from"./iframe-DmJr8_aG.js";import{G as e}from"./GlobalAccountButton-BTNSY6aM.js";import{u}from"./useAccountMenu-BG1Y_4i1.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-CCqY5Lgk.js";import"./ChevronDown-hTjRae3D.js";import"./Enter-BRo8_hWS.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-D2JR3RsC.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
