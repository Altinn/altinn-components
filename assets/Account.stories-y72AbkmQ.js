import{a7 as o}from"./iframe-C-THn91T.js";import{G as e}from"./GlobalAccountButton-LT05uIqY.js";import{u}from"./useAccountMenu-CbLXc2A6.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-CLhHIcAr.js";import"./ChevronDown-FLKzC-yj.js";import"./Enter-BepWxp12.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-DlIzna1M.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
