import{a7 as o}from"./iframe-Dmn_-H53.js";import{G as e}from"./GlobalAccountButton-BPzcPF_y.js";import{u}from"./useAccountMenu-CYZ6jSvt.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-DRCSmXVk.js";import"./ChevronDown-VmG4T_9A.js";import"./Enter-DXYuFNDS.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-9Go6A22I.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
