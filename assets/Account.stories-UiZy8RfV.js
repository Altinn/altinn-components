import{a7 as o}from"./iframe-C2dzRmjh.js";import{G as e}from"./GlobalAccountButton-1N-AzRUz.js";import{u}from"./useAccountMenu-BxjGamUx.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-JufbU_Wx.js";import"./ChevronDown-DT113Xv8.js";import"./Enter-DNhLgdXe.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-CKxTLM5T.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
