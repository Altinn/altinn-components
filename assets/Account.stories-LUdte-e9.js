import{a7 as o}from"./iframe-DklMp8b9.js";import{G as e}from"./GlobalAccountButton-Baon00uw.js";import{u}from"./useAccountMenu-V5j-nVhB.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-CX9IOnsl.js";import"./ChevronDown-C8-zew9t.js";import"./Enter-Di4UbUKP.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-DbiMma0H.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
