import{a7 as o}from"./iframe-CENvAP26.js";import{G as e}from"./GlobalAccountButton-C3e6i8a2.js";import{u}from"./useAccountMenu-UsnhQD61.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-D1pW8xSr.js";import"./ChevronDown-88nFsQYK.js";import"./Enter-CEXAJ-VY.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-Di08reZX.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
