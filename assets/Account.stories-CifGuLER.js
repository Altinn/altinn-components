import{a7 as o}from"./iframe-CH-Rf2AI.js";import{G as e}from"./GlobalAccountButton-CT8sX0Ns.js";import{u}from"./useAccountMenu-D2zJVa-5.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-BTqkjvF0.js";import"./ChevronDown-D_JnpA4f.js";import"./Enter-DkRJwzLX.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-BYSAi8Z7.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
