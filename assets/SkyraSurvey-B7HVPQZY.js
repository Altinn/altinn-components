import{ag as o,a7 as e,r}from"./iframe-CeD8DZF_.js";import"./preload-helper-PPVm8Dsz.js";function t(s){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",strong:"strong",...o(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"SkyraSurvey"}),`
...
`,e.jsxs(n.p,{children:[`| Cookie | Purpose | Lifetime |
| --- | --- | --- |
| `,e.jsx(n.code,{children:"skyra.state"}),` | Visitor id and survey status, so answered or dismissed surveys are not shown again | 365 days |
| `,e.jsx(n.code,{children:"skyra.<survey-slug>"}),` | In-progress answers while a survey is being filled out | Session |
| `,e.jsx(n.code,{children:"skyra._test"})," | Verifies that cookies work at all | Momentary |"]})]})}function h(s={}){const{wrapper:n}={...o(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{h as default};
