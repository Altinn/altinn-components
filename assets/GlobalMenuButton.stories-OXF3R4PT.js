import{G as l}from"./GlobalMenuButton-DIR4PI9u.js";import"./iframe-Ca4u80-y.js";import"./preload-helper-PPVm8Dsz.js";import"./MenuHamburger-D2oXTqoK.js";import"./Badge-nrZ8AGCl.js";import"./Tooltip-BqzPqZJ1.js";const{expect:r,within:i}=__STORYBOOK_MODULE_TEST__,b={title:"Layout/GlobalMenuButton",component:l,tags:["autodocs"],parameters:{layout:"centered"},args:{}},e={args:{}},a={args:{expanded:!0}},n={args:{badge:{variant:"base",color:"alert",label:"2"}}},t={globals:{viewport:{value:"mobile1"}},parameters:{screenshot:{skip:!0}},play:async({canvasElement:o})=>{const s=i(o),c=s.getByText("Menu");await r(c.getBoundingClientRect().width).toBeLessThanOrEqual(1),await r(s.getByRole("button",{name:"Menu"})).toBeInTheDocument()}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {}
