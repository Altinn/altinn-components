"use client";import{s as b,x as N,p as t}from"./iframe-DrMVe4hJ.js";import{u as P}from"./useIsDesktop-BPcHKUeF.js";import{c as L}from"./index-B2LUQ97G.js";import{S as F}from"./MagnifyingGlass-BYmBhmCt.js";import{S as q}from"./XMark-BXMpu0Gf.js";import{I as Q}from"./Icon-CK8FcAiF.js";import{B as T}from"./Button-B40GVZAo.js";import{A as D}from"./AutocompleteItem-CLO_ITnQ.js";import{S as R}from"./Section-BOFb_opG.js";import"./preload-helper-PPVm8Dsz.js";import"./useId-CwrI0QJg.js";import"./Skeleton-BKl0bJYN.js";import"./tooltip-BY1BnveL.js";import"./useMenu-CrRt-E4f.js";import"./MenuItem-B27UidAs.js";import"./ItemMedia-B9-jRKLO.js";import"./Avatar-toOOZ7nf.js";import"./AvatarGroup-CVynWGO_.js";import"./Checkmark-OKWU0xmP.js";import"./ItemLabel-DjesYwl7.js";import"./Heading-DYwrq57L.js";import"./useHighlightedText-BA3QT9FH.js";import"./ItemControls-ztKmX_ZB.js";import"./Badge-BnCvYltQ.js";import"./Tooltip-BEnHuPi8.js";import"./ChevronRight-u16zgCRT.js";import"./QueryLabel-DcDaMQuD.js";import"./Plus-CPTNbqFv.js";import"./MenuListItem-D8f5vRSf.js";import"./MenuListHeading-UZ0vr2Pr.js";import"./Flex-Bv-_adYq.js";const A=({className:r,autocomplete:e,expanded:n=!1,onClose:a,tabIndex:o,useGlobalHeader:p=!1,...l})=>{const[u,d]=b.useState(!1),{previousId:m,openId:i}=N(),s=P(),g=c=>{const x=c.target?.attributes?.getNamedItem("data-testid")?.value;c?.relatedTarget?.closest('[data-autocomplete="true"]')||c.relatedTarget===null||(x==="search-button-clear"||x==="search-button-close"||x==="searchbar-input"&&c.relatedTarget?.getAttribute("data-testid")!=="searchbar-input"&&c.relatedTarget?.getAttribute("data-testid")!=="search-button-clear"&&c.relatedTarget?.getAttribute("data-testid")!=="search-button-close"&&c.relatedTarget?.getAttribute("data-testid")!=="autocomplete-list")&&(s||m!=="menu"?a?.():i("menu"))};return t.jsxs(J,{className:r,expanded:n,autocomplete:!!e,onBlurCapture:g,useGlobalHeader:p,children:[t.jsx(Y,{...l,expanded:n,onClose:a,tabIndex:o,...e&&{controlsId:"searchbar-autocomplete"},onFocus:c=>{l?.onFocus?.(c),u||d(!0)},onBlur:c=>{l?.onBlur?.(c),u&&d(!1)}}),e&&t.jsx(D,{...e,expanded:n,keyboardEvents:u,onSelect:a,id:"searchbar-autocomplete"})]})},$="_searchbar_1lexx_1",M="_searchbarExpanded_1lexx_14",G="_searchbarLocal_1lexx_22",E={searchbar:$,searchbarExpanded:M,searchbarLocal:G},J=({className:r,children:e,expanded:n=!1,onBlurCapture:a,autocomplete:o=!1,useGlobalHeader:p=!1})=>{const l=L(E.searchbar,r,n&&E.searchbarExpanded,p&&E.searchbarLocal);return t.jsx("div",{className:l,"data-autocomplete":o,onBlurCapture:a,children:e})},K="_field_uxhly_1",z="_icon_uxhly_10",U="_input_uxhly_17",V="_clear_uxhly_45",X="_dismiss_uxhly_62",k={field:K,icon:z,input:U,clear:V,dismiss:X},Y=({className:r,expanded:e,name:n="q",value:a,placeholder:o="Search",closeButtonAltText:p="Close search",clearButtonAltText:l="Clear search",onFocus:u,onBlur:d,onChange:m,onClear:i,onClose:s,onEnter:g,tabIndex:c,controlsId:x})=>{const I=b.useRef(null),H=w=>{w.key==="Escape"&&I.current?.blur(),w.key==="Enter"&&(I.current?.blur(),g?.())};return t.jsxs("div",{className:L(k.field,r),children:[t.jsx("input",{ref:I,onFocus:u,onBlur:d,name:n,value:a,onChange:m,placeholder:o,className:k.input,onKeyUp:H,type:"text",autoComplete:"off",autoCapitalize:"off",enterKeyHint:"search",spellCheck:!1,"aria-autocomplete":"list",tabIndex:c??0,"aria-expanded":e,"data-testid":"searchbar-input","aria-controls":x,role:"combobox"}),t.jsx(Q,{svgElement:F,className:k.icon}),a&&t.jsx(T,{rounded:!0,size:"xs",variant:"tinted",className:k.clear,onClick:i,"data-testid":"search-button-clear","aria-label":l,children:t.jsx(q,{})})||e&&t.jsx(T,{size:"sm",variant:"ghost",className:k.dismiss,onClick:s,"data-testid":"search-button-close","aria-label":p,children:t.jsx(q,{})})]})},{expect:h,userEvent:W,waitFor:S,within:B}=__STORYBOOK_MODULE_TEST__,we={title:"Layout/Searchbar",component:A,parameters:{},args:{placeholder:"Search",name:"search",expanded:!0}},C={args:{expanded:!1}},v=()=>t.jsx(A,{name:"search",placeholder:"Søk i Altinn"}),_=()=>t.jsx(A,{name:"search",placeholder:"Søk i innboksen"}),f=r=>{const[e,n]=b.useState(r.value||""),[a,o]=b.useState(r.expanded||!1),p=i=>{n(i.target.value)},l=()=>{n("")},m={items:[...[{id:"inbox",label:e?()=>t.jsxs("span",{children:[t.jsx("mark",{children:e})," i innboksen"]}):"Alt i innboksen"},{id:"global",label:e?()=>t.jsxs("span",{children:[t.jsx("mark",{children:e})," i hele Altinn"]}):"Alt i hele Altinn"}].map(i=>({...i,groupId:"1",ariaLabel:`Søk etter ${e} i ${i.label}`,type:"scope"}))].map(i=>({...i,onClick:()=>{console.info("clicked",JSON.stringify(i))}}))};return t.jsx(A,{...r,name:"search",placeholder:"Søk i innboksen",autocomplete:m,value:e,onChange:p,onClear:l,expanded:a,onFocus:()=>o(!0),onClose:()=>{o(!1)}})},j=()=>t.jsx(R,{style:{minHeight:"176px"},children:t.jsx(f,{name:"search",expanded:!0,value:"skatt"})}),O={args:{placeholder:"Søk i innboks",expanded:!0,autocomplete:{groups:{2:{title:"2 treff i innboks"}},items:[{as:"a",role:"scope",title:"alt i innboksen",id:"1a",groupId:"1",href:"#",label:"Alt i innboks",badge:{label:"2"}},{role:"scope",title:"alt i Altinn",id:"1b",groupId:"1",href:"#",label:"Alt i hele Altinn",badge:{label:"2"}},{id:"d1",role:"dialog",groupId:"2",href:"#",title:"Skattemelding 2024"},{id:"d2",role:"dialog",groupId:"2",href:"#",title:"Skattemelding 2025"}]}}},y=r=>{const[e,n]=b.useState(""),[a,o]=b.useState(!1),p=s=>{n(s.target.value)},l=()=>{n("")},u=[{id:"inbox",label:e?()=>t.jsxs("span",{children:[t.jsx("mark",{children:e})," i innboksen"]}):"Alt i innboksen"},{id:"global",label:e?()=>t.jsxs("span",{children:[t.jsx("mark",{children:e})," i hele Altinn"]}):"Alt i hele Altinn"}].map(s=>({...s,groupId:"1",type:"scope"})),d=e?[{id:"d1",type:"dialog",title:"Skattemelding 2024",onClick:()=>alert("skatt24")},{id:"d2",type:"dialog",title:"Skattemelding 2025",onClick:()=>alert("skatt24")}].filter(s=>s.title.toLowerCase().includes((e??"").toLowerCase())).map(s=>({...s,type:"dialog",groupId:"2"})):[],m=[...u,...d].map((s,g)=>({...s,onClick:()=>{console.info("clicked item at index:"+g,JSON.stringify(s))}})),i={groups:{2:{title:`${d.length} treff i innboksen`}},items:m};return t.jsx(A,{...r,autocomplete:i,value:e,onChange:p,onClear:l,expanded:a,onFocus:()=>o(!0),onClose:()=>{o(!1)}})};y.play=async({canvasElement:r})=>{const e=B(r),n=W.setup(),a=e.getByRole("combobox");await n.type(a,"skatt"),await S(()=>h(a).toHaveAttribute("aria-expanded","true"));const o=e.getByRole("group"),p=B(o).getAllByRole("menuitem");h(p.length).toBeGreaterThanOrEqual(1),await n.click(e.getByLabelText("Skattemelding 2024")),await S(()=>h(a).toHaveAttribute("aria-expanded","false")),await n.click(e.getByTestId("search-button-clear")),h(a).toHaveValue(""),await n.type(a,"skatt"),await S(()=>h(a).toHaveAttribute("aria-expanded","true")),await n.keyboard("{ArrowDown}{ArrowDown}"),await S(()=>{const l=r.querySelector('[data-active="true"]');h(l).toBeTruthy()}),await n.keyboard("{Enter}"),await S(()=>h(a).toHaveAttribute("aria-expanded","false"))};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    expanded: false
  }
...
}`,...y.parameters?.docs?.source}}};const qe=["Default","GlobalSearch","InboxSearch","InboxScopes","InboxScopesExpanded","Expanded","ControlledState"];export{y as ControlledState,C as Default,O as Expanded,v as GlobalSearch,f as InboxScopes,j as InboxScopesExpanded,_ as InboxSearch,qe as __namedExportsOrder,we as default};
