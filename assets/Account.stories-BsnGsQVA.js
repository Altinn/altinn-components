import{a7 as o}from"./iframe-CfUrJ-sW.js";import{G as e}from"./GlobalAccountButton-giQ1XW_l.js";import{u}from"./useAccountMenu-BRlkc5pq.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-CQ8_o-yu.js";import"./ChevronDown-BqQbWOs1.js";import"./Enter-SQD6s3z_.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-C9PtCQcp.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
