import{a7 as o}from"./iframe-BtrieXtc.js";import{G as e}from"./GlobalAccountButton-CULHmsvu.js";import{u}from"./useAccountMenu-JGfUIXgR.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-CpJVuKGv.js";import"./ChevronDown-BfacC3TQ.js";import"./Enter-DOAWNqFj.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-BilN-GbW.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
