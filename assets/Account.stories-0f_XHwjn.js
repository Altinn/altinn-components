import{a7 as o}from"./iframe-DE6S9aZ4.js";import{G as e}from"./GlobalAccountButton-B1iyWna8.js";import{u}from"./useAccountMenu-DFjoHscU.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-CNN7KBYB.js";import"./ChevronDown-BW8AfmI4.js";import"./Enter-BYRDYIIB.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-CYZ6uHxs.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
