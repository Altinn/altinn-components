import{a7 as o}from"./iframe-DWxW88Wb.js";import{G as e}from"./GlobalAccountButton-COsKF7Tf.js";import{u}from"./useAccountMenu-4JeJgGma.js";import"./preload-helper-PPVm8Dsz.js";import"./Avatar-C1EBlka3.js";import"./ChevronDown-BB-XUZ3B.js";import"./Enter-Fxl2xNK-.js";import"./getAccount-CV-w7tgU.js";import"./HeartFill-4UySQMjC.js";const x={title:"Account",parameters:{layout:"centered"}},t=()=>{const{currentAccount:c}=u({accountId:"user"});return o.jsx(e,{currentAccount:{...c,type:"person"}})},n=()=>{const{currentAccount:c}=u({accountId:"diaspora"});return o.jsx(e,{currentAccount:{...c,type:"company"}})},r=()=>o.jsx(e,{});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  const {
    currentAccount
  } = useAccountMenu({
    accountId: 'user'
