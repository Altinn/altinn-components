import{a7 as d}from"./iframe-DMrRMxbq.js";import{M as m}from"./MetaItem-CJZMIJHI.js";import{S as p}from"./Eye-CAHGcl5A.js";import{S as B}from"./EyeClosed-CBxAFqTS.js";import"./preload-helper-PPVm8Dsz.js";import"./ProgressIcon-CLyvSsSz.js";import"./Avatar-C6i6C6T9.js";import"./AvatarGroup-DVS-_6qx.js";import"./Tooltip-1SJQbRAy.js";const u=({size:n="xs",label:e="Seen by label",seenByEndUser:s=!1,seenByOthersCount:c=0,onClick:i,...y})=>{const l=s||c>0?p:B;return d.jsx(m,{size:n,icon:l,...y,children:e})},L={title:"Inbox/Dialog/DialogSeenBy",component:u,tags:["autodocsi","beta"],parameters:{},args:{seenByEndUser:!0,seenByOthersCount:2,label:""}},r={args:{seenByEndUser:!1,seenByOthersCount:0}},t={args:{seenByEndUser:!0,seenByOthersCount:0}},o={args:{seenByEndUser:!0,seenByOthersCount:10}},a=({seenByEndUser:n,seenByOthersCount:e})=>{const s=[];n&&s.push("deg"),e&&s.push(e);const c="Sett av "+s.join("+");return d.jsx(u,{seenByEndUser:n,seenByOthersCount:e,label:c})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    seenByEndUser: false,
    seenByOthersCount: 0
  }
