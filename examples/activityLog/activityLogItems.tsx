import type { ActivityLogItemProps } from "../../lib";

export const activityLogItems: ActivityLogItemProps[] = [
  {
    id: "1",
    datetime: "2024-11-04",
  ...
  },
  {
    ...
    children:
      "Altinn1 ANS mistet tilgang til tjenesten Årsregnskap (RR-0002) for ANITA MEISINGSET.",
  },
  {
    id: "4",
    datetime: "2024-08-26",
    byline: "26. august 2024",
    children:
      "Altinn1 ANS mistet rollen Patent, varemerke og design for ANITA MEISINGSET.",
  },
  {
    id: "5",
    datetime: "2024-08-13",
