...
export const brregCompleted = {
  ...
  updatedAtLabel: 'Sist endret: 4. mars 2025 kl. 08.17',
  sentCount: 1,
  receivedCount: 1,
  sender: brreg,
...
export const brregArchived = {
  ...
  updatedAtLabel: 'Sist endret: 4. mars 2024 kl. 08.17',
  archived: true,
  sentCount: 1,
  receivedCount: 1,
  sender: brreg,
...
export const brregTrashed = {
  ...
  updatedAtLabel: 'Sist endret: 4. mars 2023 kl. 08.17',
  trashed: true,
  sentCount: 1,
  receivedCount: 1,
  sender: brreg,
...
export const brregTable = {
  ...
  updatedAtLabel: 'Sist endret: 22. oktober 2025 kl. 08.43',
  sender: brreg,
  badge: { theme: 'surface', label: 'Ulest' },
  children: (
    <>
