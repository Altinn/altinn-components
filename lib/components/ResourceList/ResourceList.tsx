...
import { ListBase, ListProps } from "../List";
import { ListItem, ListItemProps } from "../List/ListItem";

interface ResourceListItemAvatarProps
  extends Pick<AvatarProps, "imageUrl" | "imageUrlAlt" | "name"> {}
...
export const ResourceListItem = ({
  ...
  return (
    <ListItem
      {...props}
      avatar={{ ...avatar, type: "company", size: props.size }}
    />
  );
};
