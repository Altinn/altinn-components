...
export const ActivityLog = () => {
  return (
    <Timeline>
      ...
      <TimelineSegment>
        <TimelineActivity byline="Yesterday, 20:00">
          Activity 4.
        </TimelineActivity>
      </TimelineSegment>
      <TimelineSegment>
        <TimelineActivity byline="Yesterday, 12:00">
          Activity 3.
        </TimelineActivity>
      </TimelineSegment>
      <TimelineSegment>
        <TimelineActivity byline="Yesterday, 08:00">
          Activity 2.
        </TimelineActivity>
      </TimelineSegment>
      <TimelineSegment>
        <TimelineActivity byline="Last week">
