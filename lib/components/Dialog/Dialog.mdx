...
<Canvas of={DialogHistory.Transmissions} />

## Putting it together

A dialog is made up by the header, body and history. Potential additional information and contact information is displayed below.
