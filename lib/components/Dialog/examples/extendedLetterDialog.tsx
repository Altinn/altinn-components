...
export const extendedLetterDialog: DialogProps = {
  ...
  summary:
    "Nabovarsel for byggeplaner i for Wilhelms gate 10, 0169 Oslo (gårdsnr. 217, bruksnr. 486).",
  body: (
    <>
      <p>
        Du mottar nabovarselet fordi Borhaven Arkitekter AS har planer om å
        bygge eller gjøre endringer i nærheten av følgende eiendom:
      </p>
      <p>
        <em>
          Eugenies gate 13B, gårdsnr. 217, bruksnr. 501, seksjonsnr. 0, festenr.
          0.
        </em>
      </p>
    </>
  ...
  additionalInfo: {
    ...
    children: (
      <p>
        Hvis du mener at byggeplanene påvirker deg negativt, må du sende inn
        merknader innen 14 dager. Har du ingen merknader trenger du ikke å gjør
        enoe som helst. <a href="/">Mer om nabovarsel.</a>
      </p>
    ),
  },
};
