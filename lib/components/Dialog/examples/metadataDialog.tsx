...
export const metadataDialog: DialogProps = {
  ...
  additionalInfo: {
    ...
    children: (
      <p>
        Virksomheten får melding når det skjer noe nytt i et sykesykmeldt.
        Hvilke meldinger man får, avhenger av rollen man har.{" "}
        <a href="#koko">
          Slik går du som arbeidsgiver går frem for å håndtere sykepenger
        </a>
        .
      </p>
    ),
