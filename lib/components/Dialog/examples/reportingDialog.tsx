...
export const reportingDialog: DialogProps = {
  ...
  additionalInfo: {
    ...
    children: (
      <p>
        Din bedrift er en av 8.000 virksomheter som har opplysningsplikt i 2024.
        Statistikken er viktig for samfunnet og det er ikke valgfritt å delta.
        Hvis dere ikke sender opplysningene innen fristen, vil foretaket kunne
        få tvangsmulkt.{" "}
        <a href="https://www.ssb.no/innrapportering/ledige-stillinger">
          Les mer på SSB.no
        </a>
      </p>
    ),
