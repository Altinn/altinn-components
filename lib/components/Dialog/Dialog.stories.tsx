...
export const WithTransmissions: Story = {
  args: {
    status: {
      label: "Under arbeid",
      value: "in-progress",
    },
    title: "Rapportering av tredjepartsopplysninger",
    summary: "Her finner du alle innsendinger.",
    actions: [
      {
        id: "1",
        priority: "secondary",
        label: "Rapporter opplysninger",
      },
    ],
    additionalInfo: {
      children: (
      ...
      items: [
        {
          ...
          summary: "Skattemeldingen din er tilgjengelig.",
        },
        {
          createdAt: "2023-03-12 14:40",
          createdAtLabel: "12. mars 2023 kl 14.40",
          ...
          items: [
            {
              createdBy: skatt,
              createdAt: "2023-03-14 08:00",
              createdAtLabel: "14. mars 2023 kl 08.00",
        ...
        {
          createdAt: "2023-03-15 12:21",
          createdAtLabel: "15. mars 2023 kl 12.21",
          title: "Tredjepartsopplysninger ble levert",
          summary: "Skattemeldingen ble levert.",
          items: [
            {
