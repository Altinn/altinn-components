...
import { statusFilter, timeFilter } from './data';
...
export const SearchableAccountMenu: Story = {
  args: {
    items: [...accountMenuItems, { groupId: 'noHits', id: 'noHits', icon: InformationSquareIcon, title: 'Beklager, ingen treff. Søk på nytt!' }] as MenuItemProps[],
    groups: {
      favourites: { title: 'Favoritter' },
      aa: { title: 'Alle virksomheter' },
      search: { title: '{count} treff' },
      noHits: { title: 'Ingen treff' },
    },
    size: 'md',
    searchable: true,
    searchProps: {
