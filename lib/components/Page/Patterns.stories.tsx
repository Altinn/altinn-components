  ...
  return (
    <PageBase color="person">
      ...
      <Grid spacing={2} cols={3}>
        <DashboardCard icon={HeartIcon} title="Mine aktører">
          Sett opp favoritter og grupper for aktørene dine.
        </DashboardCard>
        <DashboardCard icon={BellIcon} title="Mine varslinger">
          Endre innstilinger for varslinger.
        </DashboardCard>
        <DashboardCard icon={CogIcon} title="Flere innstillinger">
...
export const ServicePage = (args) => {
  const { breadcrumbs, contact, sections } = args;
  return (
    <PageBase color="company">
...
export const AccountsPage = (args) => {
