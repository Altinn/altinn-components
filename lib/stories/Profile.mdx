...
<Canvas of={ProfileStories.NotificationsPage} />
...
Primary contact settings and overview of addresses in use. User should be able to remove and replace addresses that are no longer in use.

<Canvas of={ProfileStories.AddressesPage} />
